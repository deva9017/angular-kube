...
export class SecurityComponent implements OnInit {
  ...
  ngOnInit() {
    this.OwnerSecurity = JSON.parse(JSON.stringify(window.sessionStorage.getItem('OwnerSecurity')));
  ...
  next() {
    ...
    this.sessionstorageservice.set("OwnerSecurity", JSON.stringify(this.OwnerSecurity));
